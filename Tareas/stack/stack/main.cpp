...
void insertar(stack<string>& stack_data,string value) {
...
**/
void listar( stack<string>& stack_data,stack<string>& temp_stack) {
...
**/
void eliminar(stack<string>& stack_data,stack<string>& temp_stack,string delete_value) {
...
int main() {
    stack<string>datos;
    stack<string>temp; //Usado en eliminar
    string nombre;
    int opcion_menu;
    ...
    do {
        ...
        case 3:
            ...
            if(datos.empty())
                ...
                cout<<"El Stack tiene datos." <<endl;
            pausar_ejecucion();
            break;
        case 4:
            BorraPantalla();
            ...
            break;
        case 5:
            cout<<"Dato del Top: " <<datos.top() <<endl;
            pausar_ejecucion();
            break;
        case 6:
